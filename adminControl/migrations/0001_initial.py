# Generated by Django 5.1.4 on 2024-12-14 04:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navLogo', models.ImageField(blank=True, null=True, upload_to='logo/')),
                ('banner', models.ImageField(blank=True, null=True, upload_to='banner/')),
                ('title', models.CharField(blank=True, max_length=100, null=True)),
                ('contact', models.CharField(blank=True, max_length=100, null=True)),
                ('buttonText', models.CharField(blank=True, max_length=100, null=True)),
